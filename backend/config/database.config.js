...
const dbConfig = {
    ...
    atlas: {
        uri: process.env.MONGO_URI_ATLAS || "mongodb://127.0.0.1:27017/sahlnaha",
        options: {
    ...
    compass: {
        uri: process.env.MONGO_URI_COMPASS || "mongodb://127.0.0.1:27017/sahlnaha",
        options: {
            useNewUrlParser: true,
            useUnifiedTopology: true,
        }
    ...
    community: {
        uri: process.env.MONGO_URI_COMMUNITY || "mongodb://127.0.0.1:27017/sahlnaha",
        options: {
            useNewUrlParser: true,
            useUnifiedTopology: true,
        }
