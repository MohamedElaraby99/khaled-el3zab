...
process.env.MONGODB_URI = process.env.MONGODB_URI || "mongodb://127.0.0.1:27017/sahlnaha";
process.env.CLIENT_URL = process.env.CLIENT_URL || 'https://sahlnaha.fikra.solutions';
process.env.BACKEND_URL = process.env.BACKEND_URL || 'https://api.sahlnaha.fikra.solutions';
// Ensure cookies work across subdomains in production
process.env.COOKIE_DOMAIN = process.env.COOKIE_DOMAIN || '.sahlnaha.fikra.solutions';
