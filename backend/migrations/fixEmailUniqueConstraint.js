...
process.env.MONGODB_URI = process.env.MONGODB_URI || 'mongodb://127.0.0.1:27017/sahlnahanaha';
process.env.CLIENT_URL = process.env.CLIENT_URL || 'https://sahlnahanaha.fikra.solutions';
process.env.BACKEND_URL = process.env.BACKEND_URL || 'https://api.sahlnahanaha.fikra.solutions';
